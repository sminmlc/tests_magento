 ...
 *
 * @method Sminmlc_TargetRule_Model_Resource_Rule _getResource()
 * @method Sminmlc_TargetRule_Model_Resource_Rule getResource()
 * @method string getName()
 * @method Sminmlc_TargetRule_Model_Rule setName(string $value)
 * @method string getFromDate()
 * @method Sminmlc_TargetRule_Model_Rule setFromDate(string $value)
 * @method string getToDate()
 * @method Sminmlc_TargetRule_Model_Rule setToDate(string $value)
 * @method int getIsActive()
 * @method Sminmlc_TargetRule_Model_Rule setIsActive(int $value)
 * @method string getConditionsSerialized()
 * @method Sminmlc_TargetRule_Model_Rule setConditionsSerialized(string $value)
 * @method string getActionsSerialized()
 * @method Sminmlc_TargetRule_Model_Rule setActionsSerialized(string $value)
 * @method Sminmlc_TargetRule_Model_Rule setPositionsLimit(int $value)
 * @method int getApplyTo()
 * @method Sminmlc_TargetRule_Model_Rule setApplyTo(int $value)
 * @method int getSortOrder()
 * @method Sminmlc_TargetRule_Model_Rule setSortOrder(int $value)
 * @method int getUseCustomerSegment()
 * @method Sminmlc_TargetRule_Model_Rule setUseCustomerSegment(int $value)
 * @method string getActionSelect()
 * @method Sminmlc_TargetRule_Model_Rule setActionSelect(string $value)
 * @method array getCustomerSegmentIds()
 * @method Sminmlc_TargetRule_Model_Rule setCustomerSegmentIds(array $ids)
 *
 * @category    Sminmlc
 * @package     Sminmlc_TargetRule
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Sminmlc_TargetRule_Model_Rule extends Mage_Rule_Model_Abstract
{
    /**
     ...
     */
    const XML_PATH_DEFAULT_VALUES       = 'catalog/sminmlc_targetrule/';
     ...
     *
     * @return Sminmlc_TargetRule_Model_Rule
     */
    ...
    {
        return Mage::getModel('sminmlc_targetrule/rule_condition_combine');
    }

    /**
     * Getter for rule actions collection instance
     *
     * @return Sminmlc_TargetRule_Model_Actions_Condition_Combine
     */
    public function getActionsInstance()
    {
        return Mage::getModel('sminmlc_targetrule/actions_condition_combine');
    }
    ...
    public function getAppliesToOptions($withEmpty = false)
    {
        ...
        $result[Sminmlc_TargetRule_Model_Rule::RELATED_PRODUCTS]
            = Mage::helper('sminmlc_targetrule')->__('Related Products');
        $result[Sminmlc_TargetRule_Model_Rule::UP_SELLS]
            = Mage::helper('sminmlc_targetrule')->__('Up-sells');
        $result[Sminmlc_TargetRule_Model_Rule::CROSS_SELLS]
            = Mage::helper('sminmlc_targetrule')->__('Cross-sells');
        ...
        if (is_array($actionArgsList) && isset($actionArgsList['actions'])) {
            foreach ($actionArgsList['actions'] as $actionArgsIndex => $actionArgs) {
                ...
                if (!$validator->isValid($actionArgs['type'])
                    ...
                    $result[] = Mage::helper('sminmlc_targetrule')->__('Attribute code is invalid. Please use only letters (a-z), numbers (0-9) or underscore(_) in this field, first character should be a letter.');
                }
            }
        }
