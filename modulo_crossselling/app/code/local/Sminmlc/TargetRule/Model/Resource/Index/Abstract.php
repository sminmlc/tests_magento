 ...
 */
abstract class Sminmlc_TargetRule_Model_Resource_Index_Abstract extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    public function getListType()
    {
        if (is_null($this->_listType)) {
            Mage::throwException(
                Mage::helper('sminmlc_targetrule')->__('Product list type identifier does not defined')
            );
        }
