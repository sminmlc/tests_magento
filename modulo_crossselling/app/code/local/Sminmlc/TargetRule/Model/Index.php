 ...
 *
 * @method Sminmlc_TargetRule_Model_Resource_Index getResource()
 * @method Sminmlc_TargetRule_Model_Index setEntityId(int $value)
 * @method int getTypeId()
 * @method Sminmlc_TargetRule_Model_Index setTypeId(int $value)
 * @method int getFlag()
 * @method Sminmlc_TargetRule_Model_Index setFlag(int $value)
 *
 * @category    Sminmlc
 * @package     Sminmlc_TargetRule
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Sminmlc_TargetRule_Model_Index extends Mage_Index_Model_Indexer_Abstract
{
    /**
    ...
    {
        $this->_init('sminmlc_targetrule/index');
    }

    /**
     * Retrieve resource instance
     *
     * @return Sminmlc_TargetRule_Model_Mysql4_Index
     */
     ...
     *
     * @param int $type
     * @return Sminmlc_TargetRule_Model_Index
     */
    ...
    public function getLimit()
    {
        ...
        if (is_null($limit)) {
            $limit = Mage::helper('sminmlc_targetrule')->getMaximumNumberOfProduct($this->getType());
        }
        return $limit;
    }
    ...
    public function getProduct()
    {
        ...
        if (!$product instanceof Varien_Object) {
            Mage::throwException(Mage::helper('sminmlc_targetrule')->__('Please define product data object'));
        }
        return $product;
    }
     ...
     *
     * @return Sminmlc_TargetRule_Model_Mysql4_Rule_Collection
     */
    ...
    {
        return Mage::helper('sminmlc_targetrule')->__('Target Rules');
    }
    ...
    protected function _reindex($product)
    {
        ...
        /** @var $ruleCollection Sminmlc_TargetRule_Model_Resource_Rule_Collection */
        $ruleCollection = Mage::getResourceModel('sminmlc_targetrule/rule_collection');
