 ...
 */
class Sminmlc_TargetRule_Model_Actions_Condition_Product_Attributes
    extends Sminmlc_TargetRule_Model_Rule_Condition_Product_Attributes
{
    /**
    ...
    {
        parent::__construct();
        $this->setType('sminmlc_targetrule/actions_condition_product_attributes');
        $this->setValue(null);
    ...
    {
        return Mage::helper('sminmlc_targetrule')->__('Product') . ' '
    ...
    public function getValueTypeOptions()
    {
        $options = array(
            array(
                ...
                'label' => Mage::helper('sminmlc_targetrule')->__('Constant Value')
            )
        );
        ...
        if ($this->getAttribute() == 'category_ids') {
            $options[] = array(
                ...
                'label' => Mage::helper('sminmlc_targetrule')->__('the Same as Matched Product Categories')
            );
            $options[] = array(
                'value' => self::VALUE_TYPE_CHILD_OF,
                'label' => Mage::helper('sminmlc_targetrule')->__('the Child of the Matched Product Categories')
            );
        } else {
            $options[] = array(
                'value' => self::VALUE_TYPE_SAME_AS,
                'label' => Mage::helper('sminmlc_targetrule')->__('Matched Product %s', $this->getAttributeName())
            );
        }
     ...
     *
     * @param array $array
     * @return Sminmlc_TargetRule_Model_Actions_Condition_Product_Attributes
     */
    ...
    public function asString($format = '')
    {
        ...
        return sprintf(Mage::helper('sminmlc_targetrule')->__('Target Product ') . $format,
