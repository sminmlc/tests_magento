 ...
 * @package    Sminmlc_TargetRule
 */
abstract class Sminmlc_TargetRule_Block_Catalog_Product_List_Abstract
    extends Sminmlc_TargetRule_Block_Product_Abstract
{
    /**
     * TargetRule Index instance
     *
     * @var Sminmlc_TargetRule_Model_Index
     */
    protected $_index;
