 ...
 * @package    Sminmlc_TargetRule
 */
abstract class Sminmlc_TargetRule_Block_Product_Abstract extends Mage_Catalog_Block_Product_Abstract
{
    /**
     * Link collection
     *
        ...
        if (is_null($this->_linkCollection)) {
            ...
            if ($this->_linkCollection) {
                ...
                if ($rotationMode == Sminmlc_TargetRule_Model_Rule::ROTATION_SHUFFLE) {
                    Mage::getResourceSingleton('sminmlc_targetrule/index')->orderRand($select);
                } else {
    ...
    {
        $rotationMode = $this->getTargetRuleHelper()->getRotationMode($this->getProductListType());
        return $rotationMode == Sminmlc_TargetRule_Model_Rule::ROTATION_SHUFFLE;
    }
     ...
     *
     * @return Sminmlc_TargetRule_Block_Product_Abstract
     */
