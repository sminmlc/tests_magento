 ...
 * @package    Sminmlc_TargetRule
 */
class Sminmlc_TargetRule_Block_Checkout_Cart_Crosssell extends Sminmlc_TargetRule_Block_Product_Abstract
{
    /**
    ...
    {
        return Sminmlc_TargetRule_Model_Rule::CROSS_SELLS;
    }
    ...
    protected function _getTargetRuleIndex()
    {
        if (is_null($this->_index)) {
            $this->_index = Mage::getModel('sminmlc_targetrule/index');
        }
        return $this->_index;
    }
    ...
    {
        return $this->getTargetRuleHelper()->getMaximumNumberOfProduct(Sminmlc_TargetRule_Model_Rule::CROSS_SELLS);
    }
    ...
    {
        return $this->getTargetRuleHelper()->getShowProducts(Sminmlc_TargetRule_Model_Rule::CROSS_SELLS);
    }
    ...
    protected function _getProductIdsFromIndexByProduct($product, $count, $excludeProductIds = array())
    {
        return $this->_getTargetRuleIndex()
            ->setType(Sminmlc_TargetRule_Model_Rule::CROSS_SELLS)
            ->setLimit($count)
            ->setProduct($product)
